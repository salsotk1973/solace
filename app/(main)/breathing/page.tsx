  ...
  return (
    <PageShell particles={false}>
      <div className="relative z-10 max-w-[780px] mx-auto px-6 pt-[96px] md:pt-[140px] pb-28">
        ...
        <header className="text-center mb-2 md:mb-14">
          <p
            ...
            style={{ color: "rgba(60,192,212,0.80)" }}
          >
            Calm your state
          </p>
          <h1
        ...
        {/* ── Human line ──────────────────────────────────────────── */}
        <p
          className="text-center [font-family:var(--font-display)] italic font-light text-[clamp(16px,2.2vw,22px)] mt-4 mb-16 max-w-[440px] mx-auto leading-relaxed"
          style={{ color: "rgba(255,255,255,0.65)" }}
        >
          Something settles when you breathe slowly. You already know this.
        </p>

        {/* ── Other tools — desktop only ───────────────────────────── */}
        <section className="hidden md:block">
          <p
            className="text-center [font-family:var(--font-jost)] text-[12px] tracking-[0.24em] uppercase mb-6"
            style={{ color: "rgba(60,192,212,0.55)" }}
          >
            Other tools
          </p>
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link
              ...
              className="group rounded-[14px] p-6 transition-all duration-500"
              style={{
                background: glassBackground('breakdown'),
                border: `1px solid ${glassBorder('breakdown', 0.12)}`,
              }}
            >
              <p
                className="[font-family:var(--font-jost)] text-[11px] tracking-[0.18em] uppercase mb-2"
                style={{ color: `rgba(${getToolRgb('breakdown').replace(/, /g, ',')},0.55)` }}
              >
                When I feel overwhelmed
              </p>
              <p
                className="[font-family:var(--font-display)] font-light text-[20px]"
                style={{ color: "rgba(230,225,250,0.88)" }}
              >
                Break It Down
              </p>
            </Link>
      ...
      <ToolSeoContent h1="Calm your nervous system — guided breathing for clarity and steadiness">
        <p>
          When stress rises, breathing becomes shallow and fast. Your nervous system reads this as a
          threat. Breathing slowly, deeply, and intentionally sends the opposite signal. Solace guides
          you through breathing patterns designed to lower activation, so your body knows it&apos;s
          safe enough to think clearly.
        </p>
        <p>
          This isn&apos;t meditation. It&apos;s a biological reset. In 3-5 minutes, the right
          breathing pattern shifts you from reactive panic toward grounded decision-making. You stay
          in control.
        </p>
        <SeoH2>Why breathing works for stress and anxiety</SeoH2>
        <p>
          Your nervous system controls breathing automatically, but you can hijack that circuit
          intentionally. Slow, deep breathing activates the vagus nerve, which tells your body to
          downshift from fight-or-flight toward rest-and-digest. Research shows controlled breathing
          reduces stress hormones within minutes. When stress is high, breathing is your fastest tool.
        </p>
        <SeoH2>How to use Solace&apos;s breathing tool</SeoH2>
        <p>
          Choose your pace: slow for deep calm, moderate for gentle reset, faster for energy. Follow
          the guide. Breathe in rhythm. Most users feel noticeably different within 3-5 minutes. Use
          it before difficult conversations, after bad news, or when you feel overwhelm rising.
        </p>
        <SeoH2>When to use this tool</SeoH2>
        <p>
          Before you make a decision you&apos;ll regret. After a conflict. When anxiety is rising.
          When your mind is racing and you need 5 minutes of steadiness. When the weight of
          everything feels too much.
        </p>
        <SeoDisclaimer>
          This tool provides breathing guidance only. It is not medical or mental health advice. If
          you experience chest pain or serious breathing difficulty, seek medical attention
          immediately.
        </SeoDisclaimer>
      </ToolSeoContent>
    </PageShell>
