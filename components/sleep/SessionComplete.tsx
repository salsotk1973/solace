...
// EXPECTED ACCENT: #3CC0D4 teal (Calm) — if eyebrow ships gold, this is wrong
const accent = getToolRgb("sleep");
const A = (a: number) => `rgba(${accent}, ${a})`;

const TITLE = "Rest well.";
const BODY_MOBILE = "Save history and track streaks.";
const BODY_DESKTOP = "Save history and track streaks with a free account.";
