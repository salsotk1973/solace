      ...
      <div className="max-w-[720px] mx-auto px-6 py-5">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between md:gap-6">
          ...
          <div className="min-w-0">
            ...
            {/* Eyebrow row: on mobile includes close button (flex row); desktop is text-only */}
            ...
            {/* Mobile-only CTA — sits below body in reading flow */}
            {!isLoggedIn && (
              <Link
                href="/sign-up"
          ...
          {/* ── Desktop-only actions: CTA + close ───────────────── */}
